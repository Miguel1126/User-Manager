            ...
            <form action="{{ url('/form') }}" method="POST">
                ...
                <div class="row g-3 flex-wrap">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <input type="text" class="form-control" name="household" id="household">
                    </div>
                    <div class="col-6 col-md-4">
                ...
                <div class="row g-3 flex-wrap">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <input type="text" class="form-control" name="primaryCareProvider" id="primaryCareProvider">
                    </div>
                    <div class="col-6 col-md-4">
                        <label>Client PIN <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="clientPIN" id="clientPIN">
                    </div>
                </div>
                <div id="btns">
